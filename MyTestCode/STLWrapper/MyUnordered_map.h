...
class MyUnordered_map : public BrBase, public std::unordered_map< _Kty, _Ty, _Hasher, _Keyeq, MyAllocator< std::pair < const _Kty, _Ty > > > {
	using super = std::unordered_map< _Kty, _Ty, _Hasher, _Keyeq, MyAllocator< std::pair < const _Kty, _Ty > > >;
#else
class MyUnordered_map : public BrBase, public std::unordered_map < _Kty, _Ty, _Hasher, _Keyeq > {
...
template <typename _Kty, typename _Ty, typename _Hasher = std::hash<_Kty>, typename _Keyeq = std::equal_to<_Kty> >
#ifdef CUSTOM_ALLOCATOR
class MyUnordered_multimap : public BrBase, public std::unordered_multimap< _Kty, _Ty, _Hasher, _Keyeq, MyAllocator< std::pair < const _Kty, _Ty > > > {
	using super = std::unordered_multimap< _Kty, _Ty, _Hasher, _Keyeq, MyAllocator< std::pair < const _Kty, _Ty > > >;
#else
class MyUnordered_multimap : public BrBase, public std::unordered_multimap< _Kty, _Ty, _Hasher, _Keyeq > {
