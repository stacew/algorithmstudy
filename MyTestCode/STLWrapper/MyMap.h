...
class MyMap : public BrBase, public std::map< _Kty, _Ty, _Pr, MyAllocator< std::pair < const _Kty, _Ty > > > {
	using super = std::map< _Kty, _Ty, _Pr, MyAllocator< std::pair < const _Kty, _Ty > > >;
#else
class MyMap : public BrBase, public std::map< _Kty, _Ty, _Pr > {
...
template <typename _Kty, typename _Ty, typename _Pr = std::less<_Kty> >
#ifdef CUSTOM_ALLOCATOR
class MyMultimap : public BrBase, public std::multimap < _Kty, _Ty, _Pr, MyAllocator< std::pair < const _Kty, _Ty> > > {
	using super = std::multimap < _Kty, _Ty, _Pr, MyAllocator< std::pair < const _Kty, _Ty> > >;
#else
class MyMultimap : public BrBase, public std::multimap < _Kty, _Ty, _Pr > {
